...
## Own factory photos (no attribution required)

Photographed at the Metallodvor Astana production site. Source originals in
`public/photos/`.

| File | Source original |
| --- | --- |
| provoloka-vyazalnaya.jpg | IMG_1705.jpg (wire coils) |
| setka-svarnaya-karty.jpg | IMG_1692.jpg (welded mesh cards) |
...
Keep this section with the images.
...
| list-pvl.jpg | "Expanded metal" | CC BY-SA 4.0 |
| armatura.jpg | "A bunch of rebar up close" | CC BY-SA 4.0 |
| profilnaya-truba.jpg | "Steel pipe" | CC BY-SA 4.0 |

Full file pages: https://commons.wikimedia.org/wiki/File:<name>
