...
export default function Home({ onOrder }) {
  usePageMeta(
    'МеталлоДвор Астана — металлическая сетка и металлопрокат',
    'Сварная, кладочная, арматурная сетка, рабица, проволока, арматура и профильная труба с доставкой по Астане.',
  );
  ...
  return (
    <>
      ...
      <section className="container ctaBanner">
        ...
        <a className="btn btn--light" href="tel:+77771234567">Получить консультацию</a>
      </section>
    </>
  );
}
