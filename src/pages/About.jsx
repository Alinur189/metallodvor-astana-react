...
export default function About() {
  usePageMeta(
    ...
    'ТОО «МеталлоДвор» (Астана) — более 20 лет на рынке. Поставляем металлическую сетку, арматуру и металлопрокат для строительных объектов и частных заказчиков.',
    null,
    '/about',
  );
  ...
  return (
    <section className="container pageContent pageContent--single">
      <div className="pageHero">
        ...
        <p>
          <strong>ТОО «МеталлоДвор»</strong> уже более 20 лет на рынке металлопроката Астаны.
      ...
      <div className="stats">
        <div><strong>20 лет</strong><span>на рынке Астаны</span></div>
